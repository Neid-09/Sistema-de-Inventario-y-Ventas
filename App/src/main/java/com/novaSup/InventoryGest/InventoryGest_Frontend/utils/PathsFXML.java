...
public class PathsFXML {
    ...
    public static final String GESTION_PERMISOS_ROLES= "/views/ModuloConfigurar/GestPermisosRoles.fxml";
    public static final String GESTION_PERMISOS= "/views/ModuloConfigurar/Permisos.fxml";
